    ...
    public function handle()
    {
        ...
        $this->rows->each(function($row) use ($notificacion_ID) {
            ...
            try{
                ...
                var_dump($row->numero_linea);
                var_dump(Simcard::where("numero_linea",$row->numero_telefono)->get());
                var_dump(Simcard::where("numero_linea",$row->numero_telefono)->first());
                if($simcard != null){
                    ...
                    if($cliente == null){
                        ...
                        $ubicacion = Ubicacion::where("ciudad",$row->cliente_ubicacion)->first();
                        if($ubicacion != null){
