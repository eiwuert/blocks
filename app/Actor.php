...
class Actor extends Model
{
    ...
    protected $fillable = ['cedula', 'nombre', 'correo', 'telefono', 'tipo_canal', 'contratante', 'tipo_contrato', 'sueldo', 'jefe_cedula','porcentaje_equipo','porcentaje_servicio','porcentaje_prepago','porcentaje_libre','porcentaje_postpago', 'Ubicacion_ID', 'cantidad_cuotas'];
